...
dashboard-open:
	$(PYTHON) -m tools.build_eval_dashboard --report-dir "$(DASHBOARD_REPORT_DIR)" --history-db "$(DASHBOARD_HISTORY_DB)" --output "$(DASHBOARD_OUTPUT)" --open
