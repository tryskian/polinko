...
from tools.manual_eval_overlay_source_index import (
    ...
    load_overlay_source_context_index as _load_overlay_source_context_index,
    overlay_index_source_images as _overlay_index_source_images,
    source_index_public as _source_index_public,
