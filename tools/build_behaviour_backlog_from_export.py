...
LANE_DEFINITIONS: tuple[LaneDefinition, ...] = (
    ...
    LaneDefinition(
        ...
        description=(
            "Cases where execution control has to be tightened to resist commentary, reinterpretation, or fuzzy advisory drift."
        ),
        required_groups=(
            (
                SignalPattern("raw_pull", r"\braw pull\b"),
                SignalPattern("exact_text_segment", r"\bexact text segment\b"),
                SignalPattern("exactly_as_provided", r"\bexactly as provided\b"),
                SignalPattern("direct_pulls", r"\bdirect pulls\b"),
                SignalPattern("tone_fixed", r"\btone fixed\b"),
                SignalPattern("syntax_obedient", r"\bsyntax-obedient\b"),
            ...
            (
                ...
                SignalPattern("fuzzy", r"\bfuzzy\b"),
                SignalPattern("qualitative", r"\bqualitative\b"),
                SignalPattern("hedging", r"\bhedg(?:e|ing)\b"),
                SignalPattern("advisory", r"\badvis(?:ory|e)\b"),
            ),
        ),
        optional_patterns=(
            SignalPattern("pattern_tracking", r"\bpattern tracking\b"),
            SignalPattern("hyper_neutral_drift", r"\bhyper-neutral drift\b"),
            SignalPattern("baseline_tone", r"\bbaseline-tone\b"),
            SignalPattern("no_edits", r"\bno edits\b"),
            SignalPattern("exact_text", r"\bexact text\b"),
        ),
        preferred_tags=("behaviour", "eval"),
        min_score=7,
    ),
