...
- Project posture: joint human + AI collaboration with explicit human constraints,
  deterministic validation, and rollback-safe implementation cycles.
- Platform baseline: active workflow runs in Codex and runtime/eval model calls use the OpenAI API.
