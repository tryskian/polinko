...
- Archived human-reference tooling: moved `build_human_reference_db.py`, `query_human_reference.py`, `human_reference_queries.sql` to `.archive/live_archive/legacy_human_reference/` and updated references.
...
- `docs/`: updated active docs for archive/reset DB lifecycle and benchmark framing; legacy SQL is archive-only under `.archive/live_archive/legacy_human_reference/`.
