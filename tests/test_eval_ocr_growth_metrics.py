...
class OcrGrowthMetricsTests(unittest.TestCase):
    def test_build_growth_report_computes_pass_from_fail_metrics(self) -> None:
        ...
        self.assertEqual(metrics["decision_run_rate"], 1.0)
        self.assertEqual(metrics["pass_run_rate"], 0.5)
        self.assertEqual(metrics["fail_run_rate"], 0.5)
        self.assertEqual(metrics["error_run_rate"], 0.0)
    ...
    def test_build_growth_report_captures_error_first_coverage_gap(self) -> None:
        ...
        self.assertEqual(metrics["decision_run_rate"], 0.5)
        self.assertEqual(metrics["pass_run_rate"], 0.0)
        self.assertEqual(metrics["fail_run_rate"], 0.5)
        self.assertEqual(metrics["error_run_rate"], 0.5)
