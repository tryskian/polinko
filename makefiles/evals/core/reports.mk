...
.PHONY: eval-reports eval-reports-parallel build-week-demo build-week-ocr-demo build-week-ocr-notebook-demo build-week-ocr-smoke-demo
...
build-week-demo:
	@bash ./tools/run_build_week_demo.sh
