...
.PHONY: manual-evals-ocr-retry-rerun-plan
.PHONY: manual-evals-ocr-retry-selection-review
.PHONY: manual-evals-ocr-retry-selection-template
.PHONY: manual-evals-ocr-retry-selection-draft
.PHONY: manual-evals-ocr-retry-selection-validate
.PHONY: manual-evals-ocr-retry-selection-apply-preview
.PHONY: manual-evals-ocr-retry-execution-readiness

manual-evals-ocr-retry-rerun-plan:
	$(call manual_evals_db_health,--ocr-retry-rerun-plan,$(MANUAL_EVALS_OCR_RETRY_PLAN_ARGS))

manual-evals-ocr-retry-selection-review:
	$(call manual_evals_db_health,--ocr-retry-selection-review,$(MANUAL_EVALS_OCR_RETRY_PLAN_ARGS))

manual-evals-ocr-retry-selection-template:
	$(call manual_evals_db_health,--ocr-retry-selection-template,$(MANUAL_EVALS_OCR_RETRY_PLAN_ARGS))

manual-evals-ocr-retry-selection-draft:
...
manual-evals-ocr-retry-selection-validate:
...
manual-evals-ocr-retry-selection-apply-preview:
...
manual-evals-ocr-retry-execution-readiness:
