...
.PHONY: manual-evals-ocr-retry-execute
.PHONY: manual-evals-ocr-retry-execution-report

manual-evals-ocr-retry-execute:
	$(call manual_evals_db_health,--ocr-retry-execute,$(MANUAL_EVALS_OCR_RETRY_EXECUTE_ARGS))

manual-evals-ocr-retry-execution-report:
